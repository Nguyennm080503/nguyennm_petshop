<%-- 
    Document   : main
    Created on : May 12, 2023, 4:51:39 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <c:set var="msg3" value="${requestScope.notice}"/>
    <c:set var="msg4" value="${requestScope.msg}"/>
    <c:if test="${msg2 != null}">
        <script>
    ...
    <c:if test="${msg3 != null}">
        <script>
            alert("Đã mua thành công, vui lòng theo dõi lịch sử mua hàng để xem trạng thái đơn hàng");
        </script>
    </c:if>
    <c:if test="${msg4 != null}">
        <script>
            alert("Đơn hàng của bạn đã đươc mua");
        </script>
    </c:if>
    <footer>
    ...
    <style>
        ...
        .background{
            ...
            width: 100%;
            height: 578px;
            background-image: url(img/The\ PET\ SHOP.png);
