...
<html>
    ...
    <body>
        <nav>
            ...
            <main>
                <h3>Vui lòng nhập thông tin để chúng tôi có thể giao hàng cho bạn</h3>
                <div class="form">
                    <form action="MainController" method="POST">
                        <p>Tên : &emsp;&emsp;&emsp;&emsp; <input type="text" name="txtname" required=""></p>
                        <p>Số điện thoại : <input type="tel" name="txtphone" required=""></p>
                        <p>Địa chỉ : &emsp;&emsp;&emsp;<input type="text" name="txtaddress" required=""></p>
                        <p><input name="txtrole" value="2" hidden=""></p>
                        <p><input type="submit" name="action" value="Đồng ý" class="btn"></p>
                    </form>
                </div>
            </main>
        <div class="space"></div>
